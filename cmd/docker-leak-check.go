...
func newCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Short: "Leak checker for Windows Docker daemons, used to find invalid images, and unreferenced layers.",
		Run: func(cmd *cobra.Command, args []string) {
			Run(folder, remove)
		},
	}
	cmd.Flags().StringVarP(&folder, "folder", "f", "", "root of the Docker runtime")
	cmd.Flags().BoolVarP(&remove, "remove", "r", false, "remove unreferenced layers")
